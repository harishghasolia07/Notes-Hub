...
const Faq = () => {
  ...
  return (
    <div className="grid place-content-center border border-rose-500 lg:h-heightWithoutNavbar">
      <div className="mx-auto max-w-[1550px] border border-blue-500 px-5 py-8">
        <h1 className="mb-6 text-3xl font-black">Frequently Asked Questions</h1>
        <div className="grid grid-cols-1 gap-6 border border-green-500 sm:grid-cols-2 lg:grid-cols-3">
          {faqs.map((item, i) => (
